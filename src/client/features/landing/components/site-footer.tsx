...
export function SiteFooter() {
  return (
    <footer id="site-footer" className="bg-[#11131a] text-white">
      <div className="mx-auto flex max-w-[1180px] flex-col items-center justify-between gap-5 px-5 py-8 sm:flex-row sm:px-8">
        <a href="#home" className="flex items-center gap-3 font-extrabold"><img src={logoImage} alt="" className="size-8" /> Bet Bot</a>
