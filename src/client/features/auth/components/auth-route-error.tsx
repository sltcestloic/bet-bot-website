  ...
  return (
    <main className="flex min-h-svh items-center justify-center bg-[#11131a] px-5 text-center text-white">
      <section className="max-w-[430px]">
        ...
        <h1 className="mt-7 text-2xl font-black">{unavailable ? 'Service temporairement indisponible' : 'Une erreur est survenue'}</h1>
        <p className="mt-4 text-sm leading-6 text-[#b9bdc9]">Impossible de vérifier votre session pour le moment.</p>
        <button
          type="button"
          onClick={() => {
